...
3)This option is only available when in a playlist. Right click the song you want to play to prompt a pop up menu and then hover over "Current Playlist." Then click on "Play Playlist From Beginning" to play playlist from start.
